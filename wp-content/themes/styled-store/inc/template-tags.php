...
function styledstore_entry_date() {
	...
	if ( 'post' === get_post_type() && ! is_singular() ) {
		$author_description = sprintf( '<span class="byline"><span class="author vcard"><span class="posted_by">%1$s</span><a class="url fn n" href="%2$s">%3$s</a></span></span>',
		...
		printf( '
			<span class="byline clearfix"><span class="author vcard">%1$s<span class="screen-reader-text">%2$s </span>
			<div class="author-metainfo" <a class="url fn n" href="%3$s">' . esc_html__( 'by', 'styled-store' ) . ' %4$s</a>
